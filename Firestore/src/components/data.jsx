...
const Data = () => {
    ...
    return (
        <div className="container w-1/2 mx-auto mt-10">
            ...
            <div className="flex flex-col space-y-5 max-w-md mx-auto p-5 rounded-lg shadow-lg">
            ...
            <div className="mt-10 max-w-full mx-auto p-5">
                <h1 className="text-xl font-bold mb-5">Your Existing Books</h1>
                {books.map((book) => {
                    console.log("book", book)
                    if (book.creatorId !== creatorId) return null;
                    return (
                            ...
                            {editingBookId === book.id ? (
                                ...
                                <>
                                    ...
                                    <button
                                        ...
                                        onClick={() => increasePrice(book.id, book.price)}
                                    >
                                        Increase Price
                                    </button>
                                    <button
